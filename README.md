...
**현재 242개의 실제 예측 마켓이 활성화되어 있으며, 최근 3주 이내 한국, 중국, 미국, 일본의 최신 이슈 50개를 포함하여 각 카테고리별로 다양한 이벤트를 다루고 있습니다.**

### 주요 기능

✅ **회원 인증 시스템**: 로그인/회원가입 기능, 비회원 접근 제한 🆕  
✅ **관리자 페이지**: 사용자 관리, 정지/삭제 기능 🆕  
✅ **Apple 스타일 UI**: 애플 디자인 시스템 적용, 글래스모피즘 효과  
✅ **정렬 필터**: 인기순, 배팅규모, 최신순, 등록순 필터링 기능  
✅ **AI 챗봇**: 2배 확대된 AI 챗봇 아이콘 및 질문 메뉴 시스템  
...
### 4. **디자인 개선** 🆕
- ✅ **Apple-Inspired UI**: 애플 디자인 시스템 적용
  - SF Pro Display 폰트
  - 글래스모피즘 효과 (backdrop-filter blur)
  - 18-20px 둥근 모서리
  - 부드러운 큐빅 베지어 애니메이션
- ✅ **라이트 모드**: 그라데이션 배경 (#f5f7fa → #ffffff)
- ✅ **다크 모드**: 깊은 그라데이션 배경 (#000000 → #1a1a1a)
- ✅ Apple Blue 컬러 스킴 (#007aff)
- ✅ 그림자와 호버 효과로 깊이감 표현
...
- **관리자 페이지**: https://cashiq.my/admin/users.html
...
- **정렬 필터 선택** 🆕:
  - 🔥 **인기순**: 원래 순서대로 표시 (기본)
  - 📊 **배팅규모**: 거래량이 많은 순서대로 정렬
  - 📅 **최신순**: 마감일이 가장 최근인 순서대로 정렬
  - ➕ **등록순**: 최근에 등록된 이벤트 순서대로 정렬
- 인기 마켓 확인 (거래량 순)
- 각 이벤트의 결과 확률 확인
...
✅ **회원 인증 시스템** - 로그인/회원가입, 비회원 접근 제한, 정지 회원 로그인 차단 🆕  
✅ **관리자 사용자 관리** - 회원 조회/검색/정지/삭제 기능 🆕  
✅ **242개의 실제 예측 마켓** - 최근 3주 이내 한국, 중국, 미국, 일본 최신 이슈 50개 포함  
✅ **Apple-Inspired UI 디자인** - 글래스모피즘, SF Pro Display 폰트, 부드러운 애니메이션  
✅ **정렬 필터 기능** - 인기순, 배팅규모, 최신순, 이슈등록순 정렬 가능  
✅ **AI 챗봇 2배 확대** - 아이콘 및 버튼 크기 100% 증가  
✅ **배당률/수수료 섹션 제거** - UI 간소화 및 메인 마켓 집중  
...
✅ **라이트/다크 모드** - Apple 스타일 그라데이션 배경 토글  
✅ **베팅 시뮬레이션** - 실시간 수익 계산기  
...
**URL**: https://cashiq.my/admin/users.html
...
플랫폼에는 현재 **242개의 실제 예측 마켓**이 활성화되어 있습니다. 모든 이벤트는 미국, 중국, 일본, 한국 4개국의 언론 매체 및 SNS를 기반으로 선정되었습니다.

### 🆕 최근 3주 이내 주요 이슈 (50 Events 추가)

**정치 (10 Events)**
- 🇺🇸 트럼프가 2024 미국 대선에서 승리할까?
- 🇰🇷 윤석열 대통령 탄핵소추안이 통과될까?
